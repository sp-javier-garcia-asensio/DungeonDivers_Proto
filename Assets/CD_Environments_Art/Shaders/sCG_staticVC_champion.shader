...
Shader "socialPointCG/sCG_staticVC_champion" {
	Properties {
	...
	SubShader {
		...
		Tags { 	
			...
			//"Queue"="Geometry+100" 		// (default) - this is used for most objects. Opaque geometry uses this queue.
		...
		fixed4 frag(vertexOutput i) : COLOR
		{
			...
			fixed4 Complete = fixed4( DF.rgb * i.VC.rgb * _Overbright, DF.a * i.VC.a );
            Complete.a *= _Alpha;
