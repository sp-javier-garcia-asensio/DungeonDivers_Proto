...
Shader "socialPointCG/sCG_Fx_TrailAdditiveBlendUVanimationMaskedFade_SCREEN" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			vertexOutput vert(vertexInput v)
			{
				...
				o.uv0 = v.uv0 * _UVspeed.zw + (t * _UVspeed.xy);
				o.uv1 = v.uv0;
				o.VC = v.color;
			...
			fixed4 frag(vertexOutput i) : COLOR
			{
				...
				return fixed4(DF.rgb * i.VC.rgb * Mask.r * i.VC.a * _Fade, DF.a  );
			}
		ENDCG
      }
	} 
