...
Shader "socialPointCG/sCG_staticVC_animDF_TRANSPARENT" {
	Properties {
	...
	SubShader {
		...
		Tags { 	
			...
			"Queue"="Transparent-100" 	// alpha blend pixels here!
		...
		Pass {
			...
			fixed4 frag(vertexOutput i) : COLOR
			{
				...
				fixed3 Complete = DF.rgb * i.VC.rgb * _Overbright;

				fixed alpha = DF.a * i.VC.a;
