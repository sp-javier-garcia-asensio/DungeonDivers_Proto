...
Shader "socialPointCG/sCG_Fx_particlesMultiply_MULTIPLY" {
	Properties {
	...
	SubShader {
		...
		fixed4 frag(vertexOutput i) : COLOR
		{
			...
			fixed3 CombineColor = (i.VC.a) * Complete.rgb + (1 - i.VC.a) * 1;


			return fixed4(max(CombineColor, i.VC.rgb), i.VC.a * Complete.a);
		}	
